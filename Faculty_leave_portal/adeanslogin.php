  ...
  color: #7a939c;
	...
	<div id="nav" >
        ...
        <header style="margin-left:7%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>ASSOCIATE DEAN-PORTAL</h1>
        </header>
		<div class="container" style="margin-top:5%;margin-left:7%;padding:1px 16px;height:300px;background-color:#7a939c;" >
			<p><h3>
                <?php
                    ...
                    echo "ASSOCIATE DEAN-ID : ".$row["id"]."<br>";
                    echo "ASSOCIATE DEAN-Name : ".$row["f_name"]."<br>";
            ...
            <button class="button button1" onclick="window.location.href='adeanapp.php';">List Of Pending Applications</button>
