...
input[type=button], input[type=submit], input[type=reset] {
  ...
  cursor: pointer;
    ...
    <header style="margin-left:10%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>Pending Leaves for DIRECTOR</h1>
        </header>
        <div id="nav" >
				<ul>
					<li><a href="home.php">HOME</a></li>
					<li class ="active"><a href="login.php">LOGIN</a></li>   
                    <li><a href='directorlogin.php'>DIRECTOR-Portal </a></li>
				</ul>
	    </div>
        <div class="container" style="margin-top:5%;margin-left:10%;padding:1px 16px;height:100%;background-color:#7a939c;">
			<section>
                <?php
                    ...
                    $sql="SELECT * FROM leave_application WHERE current_pos='$h'";
                    ...
                    else
                    {
                        ...
                        echo "
                        <form action='directorapp_check.php' method='POST'>
                        <input type='number' name='leave_id' id='leave_id' placeholder='leave-id' required>
