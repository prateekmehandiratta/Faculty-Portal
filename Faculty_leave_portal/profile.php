  ...
  color: #7a939c;
	...
	<div id="nav" >
        ...
        <header style="margin-left:7%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>FACULTY-PORTAL</h1>
        </header>
		<div class="container" style="margin-top:5%;margin-left:7%;padding:1px 16px;height:300px;background-color:#7a939c;" >
            ...
            <button class="button button1" onclick="window.location.href = 'reviewby.php';">REVIEW YOUR APPLICATION</button>
