...
$sql="SELECT id,leavescount,nextyearleaves FROM faculty";
$result=mysqli_query($conn,$sql);
while($row=$result->fetch_array())
{
    $d=$row["nextyearleaves"];
    $id=$row["id"];
    $sql1="UPDATE faculty set leavescount='$d',nextyearleaves=30 WHERE id='$id'";
    $conn->query($sql1);
}
echo "<h2>SYSTEM RESET!!<br></h2>";
// echo "<button class='button button1'><a href='DBadmin.php'>DB-Admin </a></button>";
