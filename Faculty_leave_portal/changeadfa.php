...
?>
<?php
    if($_POST["ADFA_id"]!="")       //change ADFA
    {
        echo "<h3>change associate dean<br></h3>";
        $d_id=$_POST["ADFA_id"];
        $jd=$_POST["join_date_ADFA"];
        $ed="";
        $post="associate_dean";
        ...
        if(mysqli_num_rows($result)==0)
        {
            ...
            $conn->query($sql3);
            echo "<h3>Associate dean added<br></h3>";
        }
        else
        {
            ...
            if($id==$d_id)      //already at the post of associate dean
            {
                echo "already at the post of associate dean!!<br>";
                exit();
            }
            ...
            echo "<h3>Associate dean changed<br></h3>";
        }
    }
?>
</section>
