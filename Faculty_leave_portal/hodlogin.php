  ...
  color: #7a939c;
	...
	<div id="nav" >
        ...
        <header style="margin-left:7%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>HOD-PORTAL</h1>
        </header>
		<div class="container" style="margin-top:5%;margin-left:7%;padding:1px 16px;height:300px;background-color:#7a939c;" >
			<p><h3>
                <?php
                    ...
                    echo "HOD-ID : ".$row["id"]."<br>";
                    echo "HOD Name : ".$row["f_name"]."<br>";
            ...
            <button class="button button1" onclick="window.location.href='hodapp.php';">List Of Pending Applications</button>
