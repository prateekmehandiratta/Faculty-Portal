    ...
    session_start(); 
        ...
        if($app!="hod")     //forward or backward
        {
            if($cond==1)        //forward
            {
                ...
                <button class='button button1'><a href='hodlogin.php'>HOD-Portal </a></button>
                ";
            }
        ...
        else        //approve or reject
        {
            ...
            {
                echo "<button class='button button1'><a href ='reject.php'> Reject</a></button>
                <button class='button button1'><a href='backward.php'> Backward for Review</a></button>";
            }
        }
    ?>
    </section>
