...
session_start(); 
    ...
    if($app!="dean")     //forward or backward
    {
        if($cond==1)        //forward
        {
            ...
            {
                echo "<h3>error in updating <br></h3>";
            }
            echo"
            <button class='button button1'><a href='home.php'>Home </a></button>
            <button class='button button1'><a href='deanslogin.php'>Deans-Portal </a></button>
            ";
        }
    ...
    else        //approve or reject
    {
        ...
        {
            echo"
            <button class='button button1'><a href ='rejectdean.php'> Reject</a></button>
            <button class='button button1'><a href='backwarddean.php'> Backward for Review</a></button>
           ";
        }
    }
?>
