  ...
  cursor: pointer;
	...
	<body>
        <header style="margin-left:10%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>Pending Leaves for Associate Dean</h1>
        </header>
        <div id="nav" >
				<ul>
					<li><a href="home.php">HOME</a></li>
					<li class ="active"><a href="login.php">LOGIN</a></li>   
                    <li><a href='adeanslogin.php'>ASSOCIATE DEAN-Portal </a></li>
				</ul>
	    </div>
			...
			<section>
                <?php
                    ...
                    else
                    {
                        ...
                        echo "
                        <form action='adeanapp_check.php' method='POST'>
