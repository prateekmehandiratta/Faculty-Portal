  ...
  cursor: pointer;
	...
	<body>
        <header style="margin-left:10%;padding:1px 16px;height:10px;color:#7a939c;">
            <h1 style=background-color:black>Pending Leaves for HOD</h1>
        </header>
        <div id="nav" >
				<ul>
					<li><a href="home.php">HOME</a></li>
					<li class ="active"><a href="login.php">LOGIN</a></li>   
                    <li><a href='hodlogin.php'>HOD-Portal </a></li>
				</ul>
	    </div>
		<div class="container" style="margin-top:5%;margin-left:10%;padding:1px 16px;height:100%;background-color:#7a939c;">
			<section>
                <?php
                    ...
                    $d=$row['department'];
                    $h=$row['post'];
                    echo "<h1>DEPARTMENT : ".$d."<br></h1>";
                    $sql="SELECT * FROM leave_application WHERE current_pos='$h' and applicant_dept='$d' and applicant_id!='$uname'";
                    ...
                    else
                    {
                        ...
                        echo "
                        <form action='hodapp_check1.php' method='POST'>
